  ...
  <div id="divMain2">
            ...
            <?php echo '<input id="token" name="token" type="hidden" value="'.$zbp->GetToken('AppCentre').'"/>'?>
              <table width="100%" border="0">
                ...
                <tr height="32">
                  <td width="30%" align="left"><p><b>· 后台连接APP应用中心的方式</b><br/>
                      <span class="note">&nbsp;&nbsp;如果不能连接请切换尝试</span></p></td>
                  <td>

<label><input name="app_networktype" type="radio" value="curl" <?php echo $zbp->Config('AppCentre')->networktype=='curl'?'checked="checked"':'';?> />curl(默认)</label>&nbsp;&nbsp;&nbsp;&nbsp;
